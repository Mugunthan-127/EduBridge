  ...
  export default {
    ...
    $trs: {
      ...
      oidcGenericExplanation: {
        message:
          'EduBridge is an e-learning platform. You can also use your EduBridge account to log in to some third-party applications.',
        context: 'Generic explanation about EduBridge.',
      },
      // eslint-disable-next-line kolibri/vue-no-unused-translations
      oidcSpecificExplanation: {
        message:
          "You were sent here from the application '{app_name}'. EduBridge is an e-learning platform, and you can also use your EduBridge account to access '{app_name}'.",
        context:
          'Explanation of EduBridge that a user sees if they are sent to EduBridge from a different application.',
      },
      poweredBy: {
        message: 'EduBridge {version}',
        context:
          'Indicates the current version of EduBridge.',
      },
      poweredByKolibri: {
        message: 'Powered by EduBridge',
        context: 'Indicates that EduBridge is the technology behind this application.',
      },
      whatsThis: {
        message: "What's this?",
